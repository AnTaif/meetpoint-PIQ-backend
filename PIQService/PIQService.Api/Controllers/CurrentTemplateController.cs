...
public class CurrentTemplateController(ITemplateService templateService) : ControllerBase
{
    [HttpGet]
    ...
    public async Task<ActionResult<IEnumerable<FormWithCriteriaDto>>> GetForms()
    {
