...
namespace PIQService.Infra.Data.Migrations
{
    ...
    [Migration("20250509214222_choiceDescriptionMigration")]
    partial class choiceDescriptionMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("assessments_teams", b =>
                {
                    b.Property<Guid>("AssessmentDboId")
                        .HasColumnType("char(36)");

                    b.Property<Guid>("TeamsId")
                        .HasColumnType("char(36)");

                    b.HasKey("AssessmentDboId", "TeamsId");

                    b.HasIndex("TeamsId");

                    b.ToTable("assessments_teams");
                });
            ...
            modelBuilder.Entity("assessments_teams", b =>
                {
                    b.HasOne("PIQService.Models.Dbo.Assessments.AssessmentDbo", null)
                        .WithMany()
                        .HasForeignKey("AssessmentDboId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PIQService.Models.Dbo.TeamDbo", null)
                        .WithMany()
